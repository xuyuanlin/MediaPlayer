...
import com.flyaudio.flyMediaPlayer.until.OpenSLESConstants;
...
public class AffectActivity extends Activity implements OnSeekBarChangeListener{
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        skin = (LinearLayout) findViewById(R.id.activity_affect_skin);
        ...
        if ((mVirtualizerSupported) || (mBassBoostSupported) || (mEqualizerSupported)
            ...
            if (mVirtualizerSupported) {
                ...
                final android.widget.SeekBar seekbar = (android.widget.SeekBar) findViewById(R.id.vIStrengthSeekBar);
            ...
            if (mBassBoostSupported) {
                ...
                final android.widget.SeekBar seekbar = (android.widget.SeekBar) findViewById(R.id.bBStrengthSeekBar);
        ...
        ImageButton mButton=new ImageButton(getApplicationContext());
        mLayout.setGravity(Gravity.CENTER_VERTICAL);
        mLayout.setOrientation(0);
        mButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.effect_btn_back_style));
        mButton.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				AffectActivity.this.finish();
			}
		});
       
        mLayout.addView(mToggleSwitch);
        mLayout.addView(mButton);
        
        
        mToggleSwitch.setPadding(0,0, padding, 0);
        ab.setCustomView(mLayout, new ActionBar.LayoutParams(
    ...
    private void updateUI() {
        ...
        if (mVirtualizerSupported) {
        	android.widget.SeekBar bar = (android.widget.SeekBar) findViewById(R.id.vIStrengthSeekBar);
        ...
        if (mBassBoostSupported) {
            ((android.widget.SeekBar) findViewById(R.id.bBStrengthSeekBar)).setProgress(ControlPanelEffect
                    .getParameterInt(mContext, mCallingPackageName, mAudioSession,
    ...
    private void updateUIHeadset() {
        if (mToggleSwitch.isChecked()) {
            ...
            ((android.widget.SeekBar) findViewById(R.id.vIStrengthSeekBar)).setEnabled(
                    mIsHeadsetOn || !mVirtualizerIsHeadphoneOnly);
            ...
            ((android.widget.SeekBar) findViewById(R.id.bBStrengthSeekBar)).setEnabled(mIsHeadsetOn);
    ...
    private void equalizerBandsInit(View eqcontainer) {
        ...
        Flog.d("equalizerBandsInit----mNumberEqualizerBands---"+mNumberEqualizerBands);
